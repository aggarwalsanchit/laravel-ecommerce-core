...
class Product extends Model
{
    protected $fillable = [
        ...
        'category_id', 'pricing_type', 'price', 'sale_price', 
        'sale_start_date', 'sale_end_date', 'track_stock', 'stock',
        'low_stock_threshold', 'stock_status', 'allow_backorder',
        'weight', 'length', 'width', 'height',
        'meta_title', 'meta_description', 'meta_keywords',
        'status', 'is_featured', 'is_new', 'is_bestseller', 'is_on_sale',
        'view_count', 'order_count', 'total_sold', 'avg_rating', 'review_count'
    ];
