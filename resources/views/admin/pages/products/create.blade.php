{{-- resources/views/admin/pages/products/create.blade.php --}}
                        ...
                        <div class="card-body">
                            <form id="productForm" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select select2-single" id="vendor_id"
                                                        name="vendor_id">
                                                    ...
                                                    <small class="text-muted">Select the vendor/supplier for this
                                                        product</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    <a href="{{ route('admin.products.index') }}" class="btn btn-danger"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadBrandsByPrimaryCategory() {
                ...
                $.ajax({
                    url: '{{ url('admin/brands/by-category') }}/' + primaryId,
                    type: 'GET',
            ...
            function loadAttributesForSelectedCategories() {
                ...
                if (categoryIds.length > 0) {
                    $.ajax({
                        url: '{{ route('admin.attributes.by-categories') }}',
                        type: 'POST',
                        data: {
