{{-- resources/views/admin/pages/products/analytics.blade.php --}}
...
@section('content')
    <div class="page-content">
        <div class="page-container">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.products.analytics') }}" class="row align-items-end">
                        <div class="col-md-3">
                ...
                <div class="card-body">
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        @if (($lowStockCount ?? 0) > 0)
                            <a href="{{ route('admin.products.export-low-stock') }}" class="btn btn-warning">
