        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Edit Collection: {{ $collection->name }}</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            <h4 class="card-title">Edit Collection Information</h4>
                            <p class="text-muted mb-0">Update collection details and settings</p>
                        </div>
                        <div class="card-body">
                            <form id="collectionForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Collection Name <span
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ old('name', $collection->name) }}" autofocus>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="code" class="form-label">Collection Code <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light">
                                            ...
                                            <small class="text-muted">Unique identifier for the collection</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-1">
                                                <div id="icon-preview" class="d-inline-block">
                                                    @if ($collection->icon)
                                                        <i class="ti ti-{{ $collection->icon }} fs-4 text-primary"></i>
                                                        <span class="text-muted ms-1">Current:
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="start_date" name="start_date"
                                                value="{{ old('start_date', $collection->start_date ? $collection->start_date->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="end_date" name="end_date"
                                                value="{{ old('end_date', $collection->end_date ? $collection->end_date->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="4"
                                                placeholder="Describe this collection and what products are included...">{{ old('description', $collection->description) }}</textarea>
                                ...
                                <ul class="nav nav-tabs mt-4" id="collectionTabs" role="tablist">
                                    ...
                                    <div class="tab-pane fade show active" id="images" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border">
                                                    <div class="card-header bg-light">
                                                        <h6 class="mb-0">Collection Banner</h6>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="2"
                                                        placeholder="SEO description (150-160 characters)">{{ old('meta_description', $collection->meta_description) }}</textarea>
                                        ...
                                        <div class="card border mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="text-primary fw-bold fs-5" id="seo-preview-title">
                                                    {{ $collection->meta_title ?: $collection->name }}</div>
                                                <div class="text-muted small" id="seo-preview-url">
                                                    {{ url('/collection') }}/{{ $collection->slug }}</div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    <a href="{{ route('admin.collections.index') }}" class="btn btn-danger">
                                        <i class="ti ti-x me-1"></i> Cancel
                                    </a>
                                    <button type="submit" class="btn btn-primary" id="submitBtn">
                                        <i class="ti ti-edit me-1"></i> Update Collection
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateSEOPreview() {
                let title = $('#meta_title').val() || $('#name').val() || 'Collection Name';
                ...
                $('#seo-preview-url').text('{{ url('/collection') }}/' + slug);
            ...
            $('#icon').on('keyup', function() {
                ...
                if (icon) {
                    ...
                    $('#icon-preview').html(
                        `<i class="ti ti-{{ $collection->icon }} fs-4 text-primary"></i> <span class="text-muted ms-1">Current: {{ $collection->icon }}</span>`
                        );
                } else {
                    $('#icon-preview').html('');
                }
            ...
            $('#remove_image').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    @if (isset($collection->image) && Storage::disk('public')->exists('collections/' . $collection->image))
                        $('#imagePreview').html(`
                    <div>
            ...
            $('#remove_banner').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    @if (isset($collection->banner) && Storage::disk('public')->exists('collections/banners/' . $collection->banner))
                        $('#bannerPreview').html(`
                    <div>
                        <img src="{{ Storage::disk('public')->url('collections/banners/' . $collection->banner) }}" 
                             class="img-fluid rounded mb-2" 
                             style="max-height: 100px; width: 100%; object-fit: cover;">
                        <div class="small text-muted mt-1">
            ...
            $('#collectionForm').on('submit', function(e) {
                ...
                if (!$('#name').val().trim()) {
                    ...
                    $('#name-error').text('Collection name is required');
                    isValid = false;
                }

                if (!$('#code').val().trim()) {
                    $('#code').addClass('is-invalid');
                    $('#code-error').text('Collection code is required');
                    isValid = false;
                }
                ...
                $.ajax({
                    url: '{{ route('admin.collections.update', $collection->id) }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
