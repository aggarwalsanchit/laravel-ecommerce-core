        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Add New Collection</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            ...
                            <p class="text-muted mb-0">Create a new collection for your products (e.g., Summer Vibes, Winter
                                Warmth)</p>
                        </div>
                        <div class="card-body">
                            <form id="collectionForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Enter collection name (e.g., Summer Vibes, Winter Warmth)"
                                                    autofocus>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code"
                                                    placeholder="Enter collection code (e.g., SUM23, WIN23)">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="icon" name="icon"
                                                    placeholder="Enter icon name (e.g., sun, snowflake, star)">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">Featured collections appear on homepage</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">When the collection becomes active (optional)</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">When the collection expires (optional)</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="4"
                                                placeholder="Describe this collection and what products are included..."></textarea>
                                            <div class="invalid-feedback" id="description-error"></div>
                                            <small class="text-muted">Detailed description for SEO and collection
                                                page</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        <div class="alert alert-info mt-2 small">
                                                            <i class="ti ti-info-circle me-1"></i>
                                                            Banner for collection page header. Max size 3MB.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="seo" role="tabpanel">
                                        ...
                                        <div class="card border mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="text-primary fw-bold fs-5" id="seo-preview-title">Collection
                                                    Name</div>
                                                <div class="text-muted small" id="seo-preview-url">
                                                    {{ url('/collection') }}/collection-slug</div>
                                                <div class="text-muted small mt-2" id="seo-preview-desc">Collection
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="submitBtn">
                                        <i class="ti ti-plus me-1"></i> Create Collection
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#name').on('keyup', function() {
                ...
                $('#slug-preview').text(slug || 'collection-slug');
                updateSEOPreview();
            });
