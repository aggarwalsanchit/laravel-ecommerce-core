{{-- resources/views/admin/pages/attribute-groups/create.blade.php --}}
@extends('management.layouts.app')

@section('title', 'Add New Attribute Group')
        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Add New Attribute Group</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            ...
                            <p class="text-muted mb-0">Create a new group to organize attributes</p>
                        </div>
                        <div class="card-body">
                            <form id="groupForm">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="e.g., Technical Specifications, Physical Attributes" autofocus>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="position" name="position">
                                                <option value="top">Top (Above Product Details)</option>
                                                <option value="sidebar">Sidebar (Filter Area)</option>
                                                <option value="bottom">Bottom (Below Product Details)</option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="is_collapsible" name="is_collapsible" value="1" checked>
                                                    <label class="form-check-label" for="is_collapsible">
                                                        <i class="ti ti-chevron-down"></i> Collapsible
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="is_open_by_default" name="is_open_by_default" value="1" checked>
