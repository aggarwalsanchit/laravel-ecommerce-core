                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom border-dashed">
                                ...
                                <p class="text-muted mb-0">Edit the user's address and location details.</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="address" name="address" rows="2" placeholder="Enter street address">{{ old('address', $user->address) }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone_code" name="phone_code"
                                                value="{{ old('phone_code', $user->phone_code) }}" readonly
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city"
                                                placeholder="Enter city name" value="{{ old('city', $user->city) }}">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const originalStateId = {{ $user->state_id ?? 'null' }};
