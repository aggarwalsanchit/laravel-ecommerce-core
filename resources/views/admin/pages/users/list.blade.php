                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        <div class="d-flex flex-wrap justify-content-between gap-2">
                            ...
                            <div>
                                <a href="apps-ecommerce-products-add.html" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Users</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-2.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-3.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-8.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-13.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-14.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                            PS 5 Control
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar-md">
                                                <img src="assets/images/products/p-15.png" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
