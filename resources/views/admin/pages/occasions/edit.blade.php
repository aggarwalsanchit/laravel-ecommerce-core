{{-- resources/views/admin/occasions/edit.blade.php --}}
        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Edit Occasion: {{ $occasion->name }}</h4>
                </div>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.occasions.index') }}">Occasions</a></li>
                        <li class="breadcrumb-item active">Edit Occasion</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            <h4 class="card-title">Edit Occasion Information</h4>
                            <p class="text-muted mb-0">Update occasion details and settings</p>
                        </div>
                        <div class="card-body">
                            <form id="occasionForm" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ old('name', $occasion->name) }}" autofocus>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-1">
                                                <div id="icon-preview" class="d-inline-block">
                                                    @if ($occasion->icon)
                                                        <i class="ti ti-{{ $occasion->icon }} fs-4 text-primary"></i>
                                                        <span class="text-muted ms-2">Current icon:
                                                            {{ $occasion->icon }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="order" name="order"
                                                value="{{ old('order', $occasion->order) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch mt-2">
                                                <input type="checkbox" class="form-check-input" id="status"
                                                    name="status" value="1"
                                                    {{ old('status', $occasion->status) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch mt-2">
                                                <input type="checkbox" class="form-check-input" id="is_featured"
                                                    ...
                                                    {{ old('is_featured', $occasion->is_featured) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="4"
                                                placeholder="Describe this occasion and what products are suitable for it...">{{ old('description', $occasion->description) }}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="meta_title"
                                                        name="meta_title"
                                                        value="{{ old('meta_title', $occasion->meta_title) }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="2"
                                                        placeholder="SEO description (150-160 characters)">{{ old('meta_description', $occasion->meta_description) }}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="meta_keywords"
                                                        name="meta_keywords"
                                                        value="{{ old('meta_keywords', $occasion->meta_keywords) }}"
                                        ...
                                        <div class="card border mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="text-primary fw-bold fs-5" id="seo-preview-title">
                                                    {{ $occasion->meta_title ?: $occasion->name }}</div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="submitBtn">
                                        <i class="ti ti-edit me-1"></i> Update Occasion
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#icon').on('keyup', function() {
                ...
                if (icon) {
                    $('#icon-preview').html(
                        `<i class="ti ti-${icon} fs-4 text-primary"></i> <span class="text-muted ms-2">Icon: ${icon}</span>`
                        );
                } else {
                    $('#icon-preview').html('');
                }
            ...
            $('#remove_image').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    @if (isset($occasion->image) && Storage::disk('public')->exists('occasions/' . $occasion->image))
                        $('#imagePreview').html(`
                    <div>
            ...
            $('#occasionForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('admin.occasions.update', $occasion->id) }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
