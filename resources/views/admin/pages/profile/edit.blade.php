                                ...
                                <div class="text-center mb-4">
                                    <div class="position-relative d-inline-block">
                                        @php
                                            ...
                                            $avatarUrl = $hasAvatar ? Storage::url($admin->avatar) : null;
                                            $firstChar = strtoupper(substr($admin->name, 0, 1));
                                            $colors = [
                                                '#0d6efd',
                                                '#198754',
                                                '#dc3545',
                                            ...
                                            $colorIndex = abs(crc32($admin->name)) % count($colors);
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-3">
                                                    <input type="text" name="phone_code" id="phone_code"
                                                        ...
                                                        value="{{ old('phone_code', $admin->phone_code) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="city" id="city"
                                                ...
                                                value="{{ old('city', $admin->city) }}" placeholder="Enter city name">
                                            @error('city')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const originalStateId = {{ $admin->state_id ?? 'null' }};
