            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img src="{{ $admin->avatar_url }}" alt="Avatar" class="rounded-circle" width="120" height="120" style="object-fit: cover;">
                        </div>
            ...
            @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <p class="fw-semibold mb-0">{{ $admin->birth_date ? $admin->birth_date->format('d M Y') : 'Not provided' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <p class="fw-semibold mb-0">{{ $admin->city->name ?? 'Not provided' }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
