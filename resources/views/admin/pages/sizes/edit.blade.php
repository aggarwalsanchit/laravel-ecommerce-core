{{-- resources/views/admin/pages/sizes/edit.blade.php --}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            ...
                            <p class="text-muted mb-0">Update size information with measurements and conversion charts</p>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="tab-content mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted">
                                                        <i class="ti ti-link"></i> URL slug: <span id="slug-preview" class="text-primary">{{ $size->slug }}</span>
                                                    </small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $size->code) }}">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="gender" name="gender">
                                                        ...
                                                        <option value="Men" {{ $size->gender == 'Men' ? 'selected' : '' }}>Men</option>
                                                        <option value="Women" {{ $size->gender == 'Women' ? 'selected' : '' }}>Women</option>
                                                        <option value="Unisex" {{ $size->gender == 'Unisex' ? 'selected' : '' }}>Unisex</option>
                                                        <option value="Kids" {{ $size->gender == 'Kids' ? 'selected' : '' }}>Kids</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="order" name="order" value="{{ old('order', $size->order) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-3">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="status" name="status" value="1" {{ $size->status ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="status">
                                                                <i class="ti ti-circle-check"></i> Active
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1" {{ $size->is_featured ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="is_featured">
                                                                <i class="ti ti-star"></i> Featured
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="is_popular" name="is_popular" value="1" {{ $size->is_popular ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="3"
                                                        placeholder="Size description and fit notes">{{ old('description', $size->description) }}</textarea>
                                                ...
                                                <div class="card border">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <div id="imagePreview" class="mb-3">
                                                            @if($size->image)
                                                                <img src="{{ asset('storage/sizes/' . $size->image) }}" class="img-fluid rounded" style="max-height: 150px;">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" id="image_alt" name="image_alt" value="{{ old('image_alt', $size->image_alt) }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="chest" name="chest" value="{{ old('chest', $size->chest) }}" placeholder="e.g., 38">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="waist" name="waist" value="{{ old('waist', $size->waist) }}" placeholder="e.g., 32">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="hip" name="hip" value="{{ old('hip', $size->hip) }}" placeholder="e.g., 40">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="inseam" name="inseam" value="{{ old('inseam', $size->inseam) }}" placeholder="e.g., 32">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="shoulder" name="shoulder" value="{{ old('shoulder', $size->shoulder) }}" placeholder="e.g., 18">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="sleeve" name="sleeve" value="{{ old('sleeve', $size->sleeve) }}" placeholder="e.g., 25">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="neck" name="neck" value="{{ old('neck', $size->neck) }}" placeholder="e.g., 15">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="height" name="height" value="{{ old('height', $size->height) }}" placeholder="e.g., 5.9">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control" id="weight" name="weight" value="{{ old('weight', $size->weight) }}" placeholder="e.g., 160">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="us_size" name="us_size" value="{{ old('us_size', $size->us_size) }}" placeholder="e.g., S, 8, 38">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="uk_size" name="uk_size" value="{{ old('uk_size', $size->uk_size) }}" placeholder="e.g., S, 10, 40">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="eu_size" name="eu_size" value="{{ old('eu_size', $size->eu_size) }}" placeholder="e.g., 36, 42, 48">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="au_size" name="au_size" value="{{ old('au_size', $size->au_size) }}" placeholder="e.g., 6, 8, 10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="jp_size" name="jp_size" value="{{ old('jp_size', $size->jp_size) }}" placeholder="e.g., S, M, L">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cn_size" name="cn_size" value="{{ old('cn_size', $size->cn_size) }}" placeholder="e.g., 160, 165, 170">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="int_size" name="int_size" value="{{ old('int_size', $size->int_size) }}" placeholder="e.g., XS, S, M, L, XL">
                                    ...
                                    <div class="tab-pane fade" id="seo" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="focus_keyword" name="focus_keyword" value="{{ old('focus_keyword', $size->focus_keyword) }}" placeholder="Primary keyword for this size">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title', $size->meta_title) }}" placeholder="SEO title (50-60 characters)">
                                                    <div class="invalid-feedback" id="meta_title-error"></div>
                                                    <small class="text-muted" id="metaTitleCount">{{ strlen($size->meta_title ?? '') }}/70 characters</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted" id="metaDescCount">{{ strlen($size->meta_description ?? '') }}/160 characters</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $size->meta_keywords) }}" placeholder="keyword1, keyword2, keyword3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="url" class="form-control" id="canonical_url" name="canonical_url" value="{{ old('canonical_url', $size->canonical_url) }}" placeholder="https://example.com/canonical-url">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="og_title" name="og_title" value="{{ old('og_title', $size->og_title) }}" placeholder="Title for social sharing">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div id="ogImagePreview" class="mt-2">
                                                    @if($size->og_image)
                                                        <img src="{{ asset('storage/' . $size->og_image) }}" class="img-fluid rounded border" style="max-height: 100px;">
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="og_description" name="og_description" rows="2"
                                                        placeholder="Description for social sharing">{{ old('og_description', $size->og_description) }}</textarea>
                                        ...
                                        <div class="card border mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="text-primary fw-bold fs-5" id="seo-preview-title">{{ $size->meta_title ?? $size->name }}</div>
                                                <div class="text-muted small" id="seo-preview-url">{{ url('/size') }}/{{ $size->slug }}</div>
                                                <div class="text-muted small mt-2" id="seo-preview-desc">{{ Str::limit($size->meta_description ?? $size->description ?? 'Size description will appear here...', 160) }}</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex gap-3">
                                                    <div id="socialImagePreview" class="bg-light rounded"
                                                        ...
                                                        @if($size->og_image)
                                                            <img src="{{ asset('storage/' . $size->og_image) }}" style="width: 120px; height: 63px; object-fit: cover;">
                                                        @else
                                                            <i class="ti ti-photo text-muted"></i>
                                                        @endif
                                                    </div>
                                                    <div>
                                                        <div class="fw-semibold" id="social-preview-title">{{ $size->og_title ?? $size->meta_title ?? $size->name }}</div>
                                                        <div class="text-muted small" id="social-preview-desc">{{ Str::limit($size->og_description ?? $size->meta_description ?? $size->description ?? 'Size description...', 200) }}</div>
...
$(document).ready(function() {
    // Initialize Choices.js for categories with pre-selected values
    ...
    function updateSEOPreview() {
        ...
        let desc = $('#meta_description').val() || $('#description').val() || '{{ $size->description }}' || 'Size description will appear here...';
    ...
    function updateSocialPreview() {
        ...
        let desc = $('#og_description').val() || $('#meta_description').val() || $('#description').val() || '{{ $size->description }}' || 'Size description...';
        let slug = $('#slug-preview').text() || '{{ $size->slug }}';
