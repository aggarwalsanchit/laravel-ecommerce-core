                        ...
                        <div class="card-body">
                            <form id="sizeForm" enctype="multipart/form-data">
                                ...
                                <ul class="nav nav-tabs" id="sizeTabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" id="measurements-tab" data-bs-toggle="tab"
                                            data-bs-target="#measurements" type="button">
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane fade show active" id="basic" role="tabpanel">
                                        <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name"
                                                            name="name" placeholder="e.g., Small, Medium, Large, US 8"
                                                            autofocus>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="code"
                                                            name="code" placeholder="e.g., S, M, L, XL, US8">
                                                    </div>
                                                    <div class="invalid-feedback" id="code-error"></div>
                                                    <small class="text-muted">Unique identifier for this size (e.g., S, M,
                                                        L, XL)</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label text-muted">Associated Categories <span
                                                            class="text-danger">*</span></label>
                                                    <p class="text-muted small">Select which categories this size applies
                                                        to (you can select multiple)</p>
                                                    <select class="form-control" id="choices-categories"
                                    ...
                                    <div class="tab-pane fade" id="measurements" role="tabpanel">
                                        <div class="alert alert-info mb-3">
                                            <i class="ti ti-info-circle"></i> Measurements in inches ("). Leave empty if
                                            not applicable.
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="chest" name="chest" placeholder="e.g., 38">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="waist" name="waist" placeholder="e.g., 32">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="hip" name="hip" placeholder="e.g., 40">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="inseam" name="inseam" placeholder="e.g., 32">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="shoulder" name="shoulder" placeholder="e.g., 18">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="sleeve" name="sleeve" placeholder="e.g., 25">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="neck" name="neck" placeholder="e.g., 15">
                                                        <span class="input-group-text">inches</span>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="height" name="height" placeholder="e.g., 5.9">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.1" class="form-control"
                                                            id="weight" name="weight" placeholder="e.g., 160">
                                    ...
                                    <div class="tab-pane fade" id="conversion" role="tabpanel">
                                        <div class="alert alert-info mb-3">
                                            <i class="ti ti-info-circle"></i> International size conversions. Leave empty
                                            if not applicable.
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="us_size"
                                                        name="us_size" placeholder="e.g., S, 8, 38">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="uk_size"
                                                        name="uk_size" placeholder="e.g., S, 10, 40">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="eu_size"
                                                        name="eu_size" placeholder="e.g., 36, 42, 48">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="au_size"
                                                        name="au_size" placeholder="e.g., 6, 8, 10">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="jp_size"
                                                        name="jp_size" placeholder="e.g., S, M, L">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cn_size"
                                                        name="cn_size" placeholder="e.g., 160, 165, 170">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="int_size"
                                                        name="int_size" placeholder="e.g., XS, S, M, L, XL">
                                                    <div class="invalid-feedback" id="int_size-error"></div>
                                                    <small class="text-muted">Standard international size (XXS, XS, S, M,
                                                        L, XL, XXL, etc.)</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="focus_keyword"
                                                        name="focus_keyword" placeholder="Primary keyword for this size">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-muted small" id="social-preview-desc">Size
                                                            description...</div>
        ...
        $(document).ready(function() {
            ...
            $('#sizeForm').on('submit', function(e) {
                ...
                if (selectElement && (!selectedCategories || selectedCategories.length === 0)) {
                    selectedCategories = Array.from(selectElement.selectedOptions).map(option => option
                        .value);
                }
