                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ number_format($statistics['total_orders'] ?? 0) }}</h2>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.brands.requests') }}" class="btn btn-warning">
                                    <i class="ti ti-palette me-1"></i> Requested Brands
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="searchInput"
                                            placeholder="Search by name, code or slug..." value="{{ request('search') }}">
                                ...
                                <div class="col-md-7">
                                    <div class="d-flex gap-2 justify-content-end flex-wrap">
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-outline-secondary dropdown-toggle"
                                                data-bs-toggle="dropdown">
                                                <i class="ti ti-star me-1"></i> Featured Status
                                            </button>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" id="sortFilter">
                                                ...
                                                <li><a class="dropdown-item" href="#" data-sort="code">Code
                                                        (A-Z)</a></li>
                                                <li><a class="dropdown-item" href="#"
                                                        data-sort="products_count">Most Products</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- Bulk Actions --}}
                            @if ($admin->can('edit_brands') || $admin->can('delete_brands'))
                                <div class="row mb-3">
                                    <div class="col-12">
                            ...
                            <div id="brandsTableContainer">
                                @include('admin.pages.brands.partials.brands-table', [
                                    'brands' => $brands,
                                ])
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateStatistics(statistics) {
                ...
                $('.bg-secondary .h2').text(statistics.inactive || 0);
                $('.bg-purple .h2').text(statistics.total_views || 0);
                $('.bg-danger .h2').text(statistics.total_orders || 0);
                $('.bg-success:last .h2').text('$' + (statistics.total_revenue || 0).toLocaleString(undefined, {
        ...
        // Toggle Brand Status
        function toggleBrandStatus(brandId, action, brandName) {
            let actionText = action === 'activate' ? 'activate' : 'deactivate';
            let confirmColor = action === 'activate' ? '#28a745' : '#dc3545';

            Swal.fire({
                title: `${actionText.toUpperCase()} Brand?`,
                text: `Are you sure you want to ${actionText} "${brandName}"?`,
                icon: 'question',
        ...
        function toggleFeatured(brandId, brandName) {
            Swal.fire({
                title: 'Toggle Featured Status?',
                text: `Are you sure you want to change featured status for "${brandName}"?`,
                icon: 'question',
                showCancelButton: true,
