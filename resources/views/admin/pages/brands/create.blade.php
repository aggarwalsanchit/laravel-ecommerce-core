                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom border-dashed">
                            ...
                            <p class="text-muted mb-0">Create a new brand with optimized images and SEO</p>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name"
                                                            name="name" placeholder="Enter brand name" autofocus>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="code"
                                                            name="code" placeholder="e.g., APPLE, SAMSUNG">
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="5"
                                                        placeholder="Detailed description of the brand"></textarea>
                                                    <div class="invalid-feedback" id="description-error"></div>
                                                    <small class="text-muted" id="descCount">0/1000 characters</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card border">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <div class="invalid-feedback" id="logo_alt-error"></div>
                                    ...
                                    <div class="tab-pane fade" id="seo" role="tabpanel">
                                        ...
                                        <div class="card border mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="text-muted small mt-2" id="seo-preview-desc">Brand
                                                    description...</div>
                                            </div>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Initialize Choices.js with data-choices attribute
            ...
            if (element) {
                ...
                // Store choices instance for select/deselect all
            ...
            $('#name').on('keyup', function() {
                ...
                let code = $('#code').val();
                if (!code) {
                    let autoCode = $(this).val().toUpperCase().replace(/[^A-Z0-9]+/g, '');
                    $('#code').val(autoCode);
                }
            ...
            $('#selectAllCategories').on('click', function() {
                if (window.choicesInstance) {
                    ...
                    window.choicesInstance.setValue(allValues);
                }
            });
