{{-- resources/views/vendor/roles/create.blade.php --}}
        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Create New Role</h4>
                </div>
                <div class="text-end">
                        ...
                        <div class="card-body">
                            <form id="roleForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="e.g., Editor, Manager, Viewer" autofocus>
                                            </div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    <a href="{{ route('vendor.roles.index') }}" class="btn btn-danger">
