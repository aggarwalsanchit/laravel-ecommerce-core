{{-- resources/views/marketplace/pages/staff/create.blade.php --}}
        ...
        <div class="page-container">
            ...
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-18 text-uppercase fw-bold mb-0">Create New Staff</h4>
                </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-header border-bottom border-dashed">
                                ...
                                <p class="text-muted mb-0">Enter the staff member's basic information and contact details.
                                </p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom border-dashed">
                                ...
                                <p class="text-muted mb-0">Enter the staff member's address and location details.</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="alert alert-warning mt-3">
                                        ...
                                        <small>Note: Permissions are controlled through roles. Assigning a role will give
                                            the staff member all associated permissions.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="text-center mb-3">
                                        <div id="avatarPreview" class="mb-3">
                                            <img id="preview"
                                                src="https://ui-avatars.com/api/?name=Staff&background=0D6EFD&color=fff&size=100"
            ...
            $('#avatar').on('change', function(event) {
                ...
                if (file) {
                    ...
                    if (file.size > 2 * 1024 * 1024) {
                        ...
                        $(this).val('');
                        $('#preview').attr('src',
                            'https://ui-avatars.com/api/?name=Staff&background=0D6EFD&color=fff&size=100'
                        );
                    } else {
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error!',
                                text: 'You do not have permission to create staff.',
