{{-- resources/views/vendor/categories/my-requests.blade.php --}}
@extends('management.layouts.app')

@section('title', 'My Category Requests')
    ...
    <div class="page-container">
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 text-uppercase fw-bold mb-0">My Category Requests</h4>
            </div>
            <div class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('vendor.categories.requests.show', $request->id) }}" class="btn btn-info">
                                                <i class="ti ti-eye"></i>
                                            </a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        ...
                                        <p class="text-muted">You haven't submitted any category requests yet.</p>
                                        <a href="{{ route('vendor.categories.request.create') }}" class="btn btn-primary mt-2">
                                            <i class="ti ti-plus"></i> Request New Category
                                        </a>
                                    </td>
                                </tr>
                            @endforelse
...
$('#statusFilter').on('change', function() {
    let status = $(this).val();
    window.location.href = '{{ route("vendor.categories.requests.index") }}?status=' + status;
});
