{{-- resources/views/vendor/profile/index.blade.php --}}
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="mb-3">
                                @if ($vendor->avatar)
                                    <img src="{{ asset('storage/' . $vendor->avatar) }}" alt="Avatar"
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <a href="{{ route('vendor.profile.change-password') }}" class="btn btn-outline-secondary">
                ...
                <div class="col-xl-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <p class="fw-semibold mb-0">
                                            @if ($vendor->phone_code && $vendor->phone)
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <p class="fw-semibold mb-0">
                                            {{ $vendor->birth_date ? $vendor->birth_date->format('d M Y') : 'Not provided' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <p class="fw-semibold mb-0">{{ $vendor->address ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="text-muted small mb-1">Country</label>
                                        <p class="fw-semibold mb-0">{{ $vendor->country->name ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="text-muted small mb-1">State</label>
                                        <p class="fw-semibold mb-0">{{ $vendor->state->name ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="text-muted small mb-1">City</label>
                                        <p class="fw-semibold mb-0">{{ $vendor->city ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="text-muted small mb-1">Postal Code</label>
                                        <p class="fw-semibold mb-0">{{ $vendor->postal_code ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="text-muted small mb-1">Full Address</label>
                                        <p class="fw-semibold mb-0">{{ $vendor->full_address ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                @php
                                    $permissions = $vendor->getAllPermissions();
                                @endphp
