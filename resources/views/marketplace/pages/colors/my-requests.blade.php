{{-- resources/views/marketplace/pages/colors/my-requests.blade.php --}}
@extends('management.layouts.app')

@section('title', 'My Color Requests')
    ...
    <div class="page-container">
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 text-uppercase fw-bold mb-0">My Color Requests</h4>
            </div>
            <div class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div style="width: 25px; height: 25px; background-color: {{ $request->requested_code }}; border-radius: 50%; border: 1px solid #ddd;"></div>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('vendor.colors.requests.show', $request->id) }}" class="btn btn-info">
                                                <i class="ti ti-eye"></i>
                                            </a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        ...
                                        <p class="text-muted">You haven't submitted any color requests yet.</p>
...
$('#statusFilter').on('change', function() {
    let status = $(this).val();
    window.location.href = '{{ route("vendor.colors.requests.index") }}?status=' + status;
});
