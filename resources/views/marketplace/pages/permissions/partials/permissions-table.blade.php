{{-- resources/views/marketplace/permissions/partials/permissions-table.blade.php --}}
            ...
            <tr>
                ...
                <td class="pe-3">
                    <div class="hstack gap-1 justify-content-end">
                        ...
                        @if ($vendor->can('view_permissions'))
                            <a href="{{ route('vendor.permissions.show', $permission->id) }}"
                                class="btn btn-soft-primary btn-icon btn-sm rounded-circle" data-bs-toggle="tooltip"
                                title="View Details">
                                <i class="ti ti-eye"></i>
                            </a>
                        @endif
                        @if ($vendor->can('edit_permissions'))
                            <a href="{{ route('vendor.permissions.edit', $permission->id) }}"
                ...
                <td colspan="7" class="text-center py-5">
                    <div class="empty-state">
                        ...
                        @if ($vendor->can('create_permissions'))
                            <a href="{{ route('vendor.permissions.create') }}" class="btn btn-primary mt-2">
